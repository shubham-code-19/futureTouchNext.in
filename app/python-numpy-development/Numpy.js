...
const Numpy = () => {
  return (
    <>
      <Head>
        <title>Python-NumPy, Pandas - Future IT Touch Private Limited</title>
        <meta
          name="description"
      ...
      <div className=" relative overflow-hidden bg-[#442a79] h-96 max-sm:h-auto">
        <div className="flex max-sm:block px-28 max-sm:px-5  max-sm:py-7 gap-10  pt-12 max-pt-1">
          <div className="  ">
          ...
          <img src={app} alt="" className="w-96 pt-0 max-sm:pt-10" />
        </div>
      </div>

      <div className="flex max-sm:block gap-10 px-32 max-sm:px-5 py-14">
        <div className="">
        ...
        <img src={image} alt="" className="w-96 h-96 pt-0 max-sm:pt-10" />
      </div>
              ...
              <div key={index}>
                <div className="flex items-start gap-5">
                  ...
                  <div className="ml-2">
                    ...
                    <p className="mt-2 text-justify">{item.descriptionThree}</p>
                  </div>
                </div>
              </div>
            ))}
