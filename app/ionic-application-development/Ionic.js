...
const Ionic = () => {
  return (
    <>
      <Head>
        <title>Ionic Development - Future IT Touch Private Limited</title>
        <meta
          name="description"
      ...
      <div className="flex items-center max-lg:block gap-10 bg-[#f2f2f2]  max-sm:mt-2 px-32  max-sm:px-5 max-lg:px-10 py-14">
        ...
        <div className="w-1/3 max-lg:w-full max-lg:mt-10">
          <img src={and} alt="" className="w-full" />
        </div>
      </div>
